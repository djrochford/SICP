...
;partly into the procedure `first-denomination` and partly into the procedure `count-change` 
...
"It does not, as every possible combination is attempted no matter how the coin-values are ordered."