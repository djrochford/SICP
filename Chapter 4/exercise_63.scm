...
(rule (grandson ?grandfather ?grandson)
	  (and (son ?father ?grandon)
	  	   (son ?grandfather ?father)))

;and "If W is the wife of M, and S is the son of W, then S is the son of M"
(rule (son ?father ?child)
	  (and (wife ?father ?mother)
	  	   (son ?mother ?child)))

;(which was supposedly more true in biblical times than today) that will enable the query system to find
;the grandson of Cain; the sons of Lamech; the grandsons of Methushael. (See exercise 4.69 for some rules
