...
;that uses `amb`, to be defined by the user as part of a nondeterministic program, we would have had
;to implement it as a special form. This would require syntax procedures
