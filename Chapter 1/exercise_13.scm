...
the absolute value of phi^n/sqrt(5) - (phi^n - psi^n)/sqrt(5) = psi^n/sqrt(5)
Now, psi = -0.61803398875, so the absolute value of psi^n/sqrt(5) is less than 0.5 for all integer values of n.
