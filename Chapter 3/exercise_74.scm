...
;from physical sensors. One important feature she wishes to produce is a signal that
...
;(Assume that the sign of a 0 input is positive.) For example, a typical input signal
